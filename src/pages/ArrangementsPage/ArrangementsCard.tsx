...
const ArrangementsCard = (arrangement: Arrangement) => {
    return (
        <>
            <Card sx={{ display: 'flex', boxShadow: '10' }}>
                <CardMedia component='img' sx={{ width: '18vw', height: '28vh', }} image={img} alt='apartment image' />
                <Box sx={{
                    display: 'flex',
                    ...
                    < Box sx={{
                        ...
                        <Typography component='div' variant='body2' fontWeight='bold' padding='0 2ch 0 2ch '>
                    ...
                    <Typography component='div' variant='body2'>
                        {arrangement.tags.map((element) => (
                            `${element}  — `
                        ))}
                    </Typography>

                    <Divider sx={{ paddingTop: '1vh' }} />
                    <Box sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between', padding: '1vh 0 0 0' }} >
